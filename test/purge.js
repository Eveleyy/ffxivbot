...
describe('purge', function () {
    ...
    function hookPurge() {
        // create a promise expecting the nextPurge to be fullfilled

        return new Promise(function (resolve, reject) {

            /* unfortunately the purge is wrapped in co and does not synchronously execute when we advance
            the clock, so we have to have it resolve the promise within it */
